...
- ### Следите за будущими сообщениями и обновлениями на страничке проекта [GitHub](https://github.com/IT-Student-Education-RU) по адресу https://github.com/IT-Student-Education-RU или через его автора [*Аpo1lyon*](https://github.com/IT-Student-Education-RU)
...
Хотелось бы поблагодарить всех за эти полтора года моей (и вашей) работы.

Я получил бесценный опыт в проектировании учебных систем и преподавательской деятельности. Несмотря на все сложности и проблемы (некоторые из которых я решал выслушивая разные мнения и предложения) мне удалось создать вполне рабочую систему для обучения студентов. 

Хоть STUDENT и является до сей поры крайне сырым (со стороны разработчика) проектом, он имеет в себе очень мощные инструменты вроде **доски** и **листов успеваемости**. 

> **Если кто не знает** — эта база данных построена при помощи бесплатной программы по ведению заметок Obsidian и <small>щепотки программистской магии</small>.

Несмотря на мой уход вы должны помнить — *если вы действительно хотите научится чему-то новому, то именно **вам** нужно потратить силы и время на это новое*. Человеку могут назначать тысячу преподавателей разных способностей и мастей, но у всех них одна задача — **показать подход *как* этому новому научиться**. 

Я показал этот — *через единую базу данных с лекциями, практикой, прогрессом студентов и кучей 
инструментов*. Если такой подход не по душе и он ограничивает вас, то вы всегда можете найти свой — это ваш выбор.

Но не один преподаватель не сможет вас научить, если именно **вы** не захотите этого.

**Благодарю всех кто пользовался STUDENT для получения новых знаний. Надеюсь, скоро увидимся.**
