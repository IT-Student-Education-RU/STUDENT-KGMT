...
|:-----------------------:|:----------------------------------------------- |:----------------------------------- |:------------:|:---------------:|:-------------------:|:-----------------------:|:---------------------------------------------------:|
|        15.01.25         | [[Переопределение функционала базового класса]] | [[Задание. Переопределение класса]] |      1       |        1        |                     |                         | 15.01.25 %%[[Бражник. Переопределение класса.py]]%% |
|                         |                                                 |                                     |              |                 |                     |                         |                                                     |
|        **Итого**        |                                                 |                                     |      1       |        1        |          0          |                         |                                                     |
<!-- TBLFM: @>$4=sum(@I..@-1) -->
<!-- TBLFM: @>$5=sum(@I..@-1) -->
...
| ------------------- | --------------------------- |:---------------:|:----------:|:--------------:|
| Личный проект       | Генератор лута для игры DnD |        —        |  20.01.25  |       +5       |
|                     |                             |                 |            |                |
|                     |                             |                 |            |                |
|                     |                             |                 |            |                |
| **Итого**           |                             |                 |            |       5        |
...
| Дата проведения занятия | Тема мп.          | Название практического задания      | Мп. изучено? | Пз. выполненно? | Синопсис рассказан? | Дата рассказа синопсиса | Дата проверки пз. |
|:-----------------------:|:----------------- |:----------------------------------- |:------------:|:---------------:|:-------------------:|:-----------------------:|:-----------------:|
|        17.01.25         | [[Модели данных]] | [[Задание. Модуль 2 в SQL Academy]] |      1       |        1        |                     |                         |     22.01.25      |
|                         |                   |                                     |              |                 |                     |                         |                   |
|        **Итого**        |                   |                                     |      1       |        1        |          0          |                         |                   |
<!-- TBLFM: @>$4=sum(@I..@-1) -->
<!-- TBLFM: @>$5=sum(@I..@-1) -->
