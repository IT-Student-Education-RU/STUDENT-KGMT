...
| :---------------------: | :---------------------------------------------- | :---------------------------------- | :----------: | :-------------: | :-----------------: | :---------------------: | :--------------------------------------------------: |
|        15.01.25         | [[Переопределение функционала базового класса]] | [[Задание. Переопределение класса]] |      1       |        1        |                     |                         | 29.01.25 %%[[Михайлов Д. Энимал класс и гэймс.py]]%% |
|                         |                                                 |                                     |              |                 |                     |                         |                                                      |
|        **Итого**        |                                                 |                                     |      1       |        1        |          0          |                         |                                                      |
<!-- TBLFM: @>$4=sum(@I..@-1) -->
<!-- TBLFM: @>$5=sum(@I..@-1) -->
...
| Дата проведения занятия | Тема мп.          | Название практического задания      | Мп. изучено? | Пз. выполненно? | Синопсис рассказан? | Дата рассказа синопсиса | Дата проверки пз. |
|:-----------------------:|:----------------- |:----------------------------------- |:------------:|:---------------:|:-------------------:|:-----------------------:|:-----------------:|
|        17.01.25         | [[Модели данных]] | [[Задание. Модуль 2 в SQL Academy]] |      1       |        1        |                     |                         |     29.01.25      |
|                         |                   |                                     |              |                 |                     |                         |                   |
|        **Итого**        |                   |                                     |      1       |        1        |          0          |                         |                   |
<!-- TBLFM: @>$4=sum(@I..@-1) -->
<!-- TBLFM: @>$5=sum(@I..@-1) -->
...
| Название активности | Тема                     | Дата назначения | Дата сдачи | Получено очков |
| ------------------- | ------------------------ | :-------------: | :--------: | :------------: |
| Реферат             | Транзисторы в процессоре |    19.11.24     |            |                |
|                     |                          |                 |            |                |
|                     |                          |                 |            |                |
|                     |                          |                 |            |                |
| **Итого**           |                          |                 |            |       0        |
...
Дата добавления: `2025-01-15, 19:10`

Вы получаете +`3` балл(ов) по причине `Закончил полугодичный модуль по алгоритмизации и программированию`