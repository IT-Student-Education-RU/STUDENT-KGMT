...
let list_privilege = []
let list_restrictions = [ '<span style = "color: #FF0000">Особый контроль.</span>' , 
						'<span style = "color: #FF0000">Контроль преподавателем.</span>',
						'<span style = "color: #BF3030">Ограничение в уважительных причинах.</span>', '<span style = "color: #A60000">Низкая порядочность.</span>`]
